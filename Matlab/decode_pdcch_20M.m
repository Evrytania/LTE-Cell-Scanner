function peak_out=decode_pdcch_20M(peak,tfg)
...
% Channel estimation
ce_tfg=NaN(n_ofdm,1200,4);
[ce_tfg(:,:,1) np0]=chan_est_20M(peak,tfg,0);
[ce_tfg(:,:,2) np1]=chan_est_20M(peak,tfg,1);
[ce_tfg(:,:,3) np2]=chan_est_20M(peak,tfg,2);
[ce_tfg(:,:,4) np3]=chan_est_20M(peak,tfg,3);
