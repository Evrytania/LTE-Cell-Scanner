...
static asn_TYPE_member_t asn_MBR_RF_Parameters_v1130_1[] = {
...
static int asn_MAP_RF_Parameters_v1130_oms_1[] = { 0 };
static ber_tlv_tag_t asn_DEF_RF_Parameters_v1130_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_RF_Parameters_v1130_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 } /* supportedBandCombination-v1130 */
};
static asn_SEQUENCE_specifics_t asn_SPC_RF_Parameters_v1130_specs_1 = {
