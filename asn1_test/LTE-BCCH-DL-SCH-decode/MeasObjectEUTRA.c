...
static asn_TYPE_member_t asn_MBR_MeasObjectEUTRA_1[] = {
	...
	{ ATF_POINTER, 5, offsetof(struct MeasObjectEUTRA, measCycleSCell_r10),
	...
	{ ATF_POINTER, 4, offsetof(struct MeasObjectEUTRA, measSubframePatternConfigNeigh_r10),
	...
	{ ATF_POINTER, 3, offsetof(struct MeasObjectEUTRA, widebandRSRQ_Meas_r11),
	...
	{ ATF_POINTER, 2, offsetof(struct MeasObjectEUTRA, altTTT_CellsToRemoveList_r12),
	...
	{ ATF_POINTER, 1, offsetof(struct MeasObjectEUTRA, altTTT_CellsToAddModList_r12),
