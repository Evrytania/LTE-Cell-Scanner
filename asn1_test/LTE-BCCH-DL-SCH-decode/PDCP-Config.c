...
static asn_INTEGER_enum_map_t asn_MAP_pdcp_SN_Size_v1130_value2enum_35[] = {
	{ 0,	9,	"len15bits" }
};
static unsigned int asn_MAP_pdcp_SN_Size_v1130_enum2value_35[] = {
	0	/* len15bits(0) */
};
static asn_INTEGER_specifics_t asn_SPC_pdcp_SN_Size_v1130_specs_35 = {
...
static ber_tlv_tag_t asn_DEF_pdcp_SN_Size_v1130_tags_35[] = {
	(ASN_TAG_CLASS_CONTEXT | (5 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (10 << 2))
};
static /* Use -fall-defs-global to expose */
...
static asn_TYPE_member_t asn_MBR_PDCP_Config_1[] = {
	...
	{ ATF_POINTER, 2, offsetof(struct PDCP_Config, rn_IntegrityProtection_r10),
		(ASN_TAG_CLASS_CONTEXT | (4 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 1, offsetof(struct PDCP_Config, pdcp_SN_Size_v1130),
		(ASN_TAG_CLASS_CONTEXT | (5 << 2)),
		-1,	/* IMPLICIT tag at current level */
...
static int asn_MAP_PDCP_Config_oms_1[] = { 0, 1, 2, 4, 5 };
