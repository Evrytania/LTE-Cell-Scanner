...
static asn_TYPE_member_t asn_MBR_MAC_MainConfig_1[] = {
	...
	{ ATF_POINTER, 6, offsetof(struct MAC_MainConfig, phr_Config),
		(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
		+1,	/* EXPLICIT tag at current level */
	...
	{ ATF_POINTER, 5, offsetof(struct MAC_MainConfig, sr_ProhibitTimer_r9),
	...
	{ ATF_POINTER, 4, offsetof(struct MAC_MainConfig, mac_MainConfig_v1020),
		(ASN_TAG_CLASS_CONTEXT | (5 << 2)),
		0,
	...
	{ ATF_POINTER, 3, offsetof(struct MAC_MainConfig, stag_ToReleaseList_r11),
	...
	{ ATF_POINTER, 2, offsetof(struct MAC_MainConfig, stag_ToAddModList_r11),
	...
	{ ATF_POINTER, 1, offsetof(struct MAC_MainConfig, drx_Config_v1130),
...
static int asn_MAP_MAC_MainConfig_oms_1[] = { 0, 1, 3, 4, 5, 6, 7, 8 };
