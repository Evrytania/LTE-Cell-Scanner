...
static asn_TYPE_member_t asn_MBR_RadioResourceConfigDedicatedSCell_r10_1[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct RadioResourceConfigDedicatedSCell_r10, mac_MainConfigSCell_r11),
...
static int asn_MAP_RadioResourceConfigDedicatedSCell_r10_oms_1[] = { 0, 1 };
