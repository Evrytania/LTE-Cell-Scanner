...
static asn_TYPE_member_t asn_MBR_ReportConfigEUTRA_1[] = {
	...
	{ ATF_POINTER, 5, offsetof(struct ReportConfigEUTRA, si_RequestForHO_r9),
		(ASN_TAG_CLASS_CONTEXT | (6 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 4, offsetof(struct ReportConfigEUTRA, ue_RxTxTimeDiffPeriodical_r9),
		(ASN_TAG_CLASS_CONTEXT | (7 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 3, offsetof(struct ReportConfigEUTRA, includeLocationInfo_r10),
		(ASN_TAG_CLASS_CONTEXT | (8 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 2, offsetof(struct ReportConfigEUTRA, reportAddNeighMeas_r10),
		(ASN_TAG_CLASS_CONTEXT | (9 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 1, offsetof(struct ReportConfigEUTRA, alternativeTimeToTrigger_r12),
