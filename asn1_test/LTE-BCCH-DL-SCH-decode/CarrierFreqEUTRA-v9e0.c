...
static asn_TYPE_member_t asn_MBR_CarrierFreqEUTRA_v9e0_1[] = {
...
static int asn_MAP_CarrierFreqEUTRA_v9e0_oms_1[] = { 1 };
static ber_tlv_tag_t asn_DEF_CarrierFreqEUTRA_v9e0_tags_1[] = {
