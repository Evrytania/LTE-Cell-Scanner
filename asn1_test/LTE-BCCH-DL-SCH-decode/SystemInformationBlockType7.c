...
static asn_TYPE_member_t asn_MBR_SystemInformationBlockType7_1[] = {
	...
	{ ATF_POINTER, 2, offsetof(struct SystemInformationBlockType7, t_ReselectionGERAN_SF),
	...
	{ ATF_POINTER, 1, offsetof(struct SystemInformationBlockType7, carrierFreqsInfoList),
...
static int asn_MAP_SystemInformationBlockType7_oms_1[] = { 1, 2 };
