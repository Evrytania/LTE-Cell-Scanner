...
static int
memb_physCellIdList_r11_constraint_1(asn_TYPE_descriptor_t *td, const void *sptr,
...
static asn_per_constraints_t asn_PER_type_physCellIdList_r11_constr_3 GCC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 6,  6,  1,  40 }	/* (SIZE(1..40)) */,
	0, 0	/* No PER value map */
};
static asn_per_constraints_t asn_PER_memb_physCellIdList_r11_constr_3 GCC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 6,  6,  1,  40 }	/* (SIZE(1..40)) */,
	0, 0	/* No PER value map */
};
...
static ber_tlv_tag_t asn_DEF_physCellIdList_r11_tags_3[] = {
...
asn_TYPE_descriptor_t asn_DEF_physCellIdList_r11_3 = {
	...
	&asn_PER_type_physCellIdList_r11_constr_3,
	asn_MBR_physCellIdList_r11_3,
	1,	/* Single element */
	&asn_SPC_physCellIdList_r11_specs_3	/* Additional specs */
};

static asn_TYPE_member_t asn_MBR_NeighCellsPerBandclassCDMA2000_r11_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct NeighCellsPerBandclassCDMA2000_r11, physCellIdList_r11),
		...
		memb_physCellIdList_r11_constraint_1,
		&asn_PER_memb_physCellIdList_r11_constr_3,
		0,
		"physCellIdList-r11"
		},
};
static ber_tlv_tag_t asn_DEF_NeighCellsPerBandclassCDMA2000_r11_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_NeighCellsPerBandclassCDMA2000_r11_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* arfcn */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* physCellIdList-r11 */
};
static asn_SEQUENCE_specifics_t asn_SPC_NeighCellsPerBandclassCDMA2000_r11_specs_1 = {
