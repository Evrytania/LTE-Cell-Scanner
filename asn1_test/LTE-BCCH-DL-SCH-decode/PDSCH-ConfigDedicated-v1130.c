...
static int
qcl_Operation_3_constraint(asn_TYPE_descriptor_t *td, const void *sptr,
 ...
 */
static void
qcl_Operation_3_inherit_TYPE_descriptor(asn_TYPE_descriptor_t *td) {
...
static void
qcl_Operation_3_free(asn_TYPE_descriptor_t *td,
		void *struct_ptr, int contents_only) {
	qcl_Operation_3_inherit_TYPE_descriptor(td);
	td->free_struct(td, struct_ptr, contents_only);
}

static int
qcl_Operation_3_print(asn_TYPE_descriptor_t *td, const void *struct_ptr,
...
qcl_Operation_3_decode_ber(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
qcl_Operation_3_encode_der(asn_TYPE_descriptor_t *td,
...
static asn_dec_rval_t
qcl_Operation_3_decode_xer(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
static asn_enc_rval_t
qcl_Operation_3_encode_xer(asn_TYPE_descriptor_t *td, void *structure,
...
static asn_dec_rval_t
qcl_Operation_3_decode_uper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
static asn_enc_rval_t
qcl_Operation_3_encode_uper(asn_TYPE_descriptor_t *td,
...
static asn_per_constraints_t asn_PER_type_qcl_Operation_constr_3 GCC_NOTUSED = {
	{ APC_CONSTRAINED,	 1,  1,  0,  1 }	/* (0..1) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_INTEGER_enum_map_t asn_MAP_qcl_Operation_value2enum_3[] = {
	{ 0,	5,	"typeA" },
	{ 1,	5,	"typeB" }
};
static unsigned int asn_MAP_qcl_Operation_enum2value_3[] = {
	0,	/* typeA(0) */
	1	/* typeB(1) */
};
static asn_INTEGER_specifics_t asn_SPC_qcl_Operation_specs_3 = {
...
static ber_tlv_tag_t asn_DEF_qcl_Operation_tags_3[] = {
...
asn_TYPE_descriptor_t asn_DEF_qcl_Operation_3 = {
	"qcl-Operation",
	"qcl-Operation",
	qcl_Operation_3_free,
	qcl_Operation_3_print,
	qcl_Operation_3_constraint,
	qcl_Operation_3_decode_ber,
	qcl_Operation_3_encode_der,
	qcl_Operation_3_decode_xer,
	qcl_Operation_3_encode_xer,
	qcl_Operation_3_decode_uper,
	qcl_Operation_3_encode_uper,
	...
	&asn_PER_type_qcl_Operation_constr_3,
	0, 0,	/* Defined elsewhere */
	&asn_SPC_qcl_Operation_specs_3	/* Additional specs */
};

static asn_TYPE_member_t asn_MBR_PDSCH_ConfigDedicated_v1130_1[] = {
...
static int asn_MAP_PDSCH_ConfigDedicated_v1130_oms_1[] = { 0, 1, 2, 3 };
static ber_tlv_tag_t asn_DEF_PDSCH_ConfigDedicated_v1130_tags_1[] = {
