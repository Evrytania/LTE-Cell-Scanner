...
static asn_TYPE_member_t asn_MBR_ReportConfigInterRAT_1[] = {
	...
	{ ATF_POINTER, 3, offsetof(struct ReportConfigInterRAT, si_RequestForHO_r9),
		(ASN_TAG_CLASS_CONTEXT | (4 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 2, offsetof(struct ReportConfigInterRAT, reportQuantityUTRA_FDD_r10),
		(ASN_TAG_CLASS_CONTEXT | (5 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 1, offsetof(struct ReportConfigInterRAT, includeLocationInfo_r11),
...
static int asn_MAP_ReportConfigInterRAT_oms_1[] = { 4, 5, 6 };
