...
static asn_TYPE_member_t asn_MBR_MeasObjectUTRA_1[] = {
	...
	{ ATF_NOFLAGS, 4, offsetof(struct MeasObjectUTRA, offsetFreq),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 3, offsetof(struct MeasObjectUTRA, cellsToRemoveList),
	...
	{ ATF_POINTER, 2, offsetof(struct MeasObjectUTRA, cellsToAddModList),
	...
	{ ATF_POINTER, 1, offsetof(struct MeasObjectUTRA, cellForWhichToReportCGI),
...
static int asn_MAP_MeasObjectUTRA_oms_1[] = { 1, 2, 3, 4 };
