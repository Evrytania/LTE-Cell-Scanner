...
static int
ra_ResponseWindowSize_55_constraint(asn_TYPE_descriptor_t *td, const void *sptr,
			asn_app_constraint_failed_f *ctfailcb, void *app_key) {
	/* Replace with underlying type checker */
	td->check_constraints = asn_DEF_NativeEnumerated.check_constraints;
	return td->check_constraints(td, sptr, ctfailcb, app_key);
 ...
 */
static void
ra_ResponseWindowSize_55_inherit_TYPE_descriptor(asn_TYPE_descriptor_t *td) {
	td->free_struct    = asn_DEF_NativeEnumerated.free_struct;
	td->print_struct   = asn_DEF_NativeEnumerated.print_struct;
	td->check_constraints = asn_DEF_NativeEnumerated.check_constraints;
	td->ber_decoder    = asn_DEF_NativeEnumerated.ber_decoder;
...
static void
ra_ResponseWindowSize_55_free(asn_TYPE_descriptor_t *td,
		void *struct_ptr, int contents_only) {
	ra_ResponseWindowSize_55_inherit_TYPE_descriptor(td);
	td->free_struct(td, struct_ptr, contents_only);
}

static int
ra_ResponseWindowSize_55_print(asn_TYPE_descriptor_t *td, const void *struct_ptr,
		int ilevel, asn_app_consume_bytes_f *cb, void *app_key) {
	ra_ResponseWindowSize_55_inherit_TYPE_descriptor(td);
	return td->print_struct(td, struct_ptr, ilevel, cb, app_key);
}
...
static asn_dec_rval_t
ra_ResponseWindowSize_55_decode_ber(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
		void **structure, const void *bufptr, size_t size, int tag_mode) {
	ra_ResponseWindowSize_55_inherit_TYPE_descriptor(td);
	return td->ber_decoder(opt_codec_ctx, td, structure, bufptr, size, tag_mode);
}
...
static asn_enc_rval_t
ra_ResponseWindowSize_55_encode_der(asn_TYPE_descriptor_t *td,
		void *structure, int tag_mode, ber_tlv_tag_t tag,
		asn_app_consume_bytes_f *cb, void *app_key) {
	ra_ResponseWindowSize_55_inherit_TYPE_descriptor(td);
	return td->der_encoder(td, structure, tag_mode, tag, cb, app_key);
...
static asn_dec_rval_t
ra_ResponseWindowSize_55_decode_xer(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
		void **structure, const char *opt_mname, const void *bufptr, size_t size) {
	ra_ResponseWindowSize_55_inherit_TYPE_descriptor(td);
	return td->xer_decoder(opt_codec_ctx, td, structure, opt_mname, bufptr, size);
}
...
static asn_enc_rval_t
ra_ResponseWindowSize_55_encode_xer(asn_TYPE_descriptor_t *td, void *structure,
		int ilevel, enum xer_encoder_flags_e flags,
		asn_app_consume_bytes_f *cb, void *app_key) {
	ra_ResponseWindowSize_55_inherit_TYPE_descriptor(td);
	return td->xer_encoder(td, structure, ilevel, flags, cb, app_key);
...
static asn_dec_rval_t
ra_ResponseWindowSize_55_decode_uper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints, void **structure, asn_per_data_t *per_data) {
	ra_ResponseWindowSize_55_inherit_TYPE_descriptor(td);
	return td->uper_decoder(opt_codec_ctx, td, constraints, structure, per_data);
}
...
static asn_enc_rval_t
ra_ResponseWindowSize_55_encode_uper(asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints,
		void *structure, asn_per_outp_t *per_out) {
	ra_ResponseWindowSize_55_inherit_TYPE_descriptor(td);
	return td->uper_encoder(td, constraints, structure, per_out);
...
static int
mac_ContentionResolutionTimer_64_constraint(asn_TYPE_descriptor_t *td, const void *sptr,
			asn_app_constraint_failed_f *ctfailcb, void *app_key) {
	/* Replace with underlying type checker */
	td->check_constraints = asn_DEF_NativeEnumerated.check_constraints;
	return td->check_constraints(td, sptr, ctfailcb, app_key);
 ...
 */
static void
mac_ContentionResolutionTimer_64_inherit_TYPE_descriptor(asn_TYPE_descriptor_t *td) {
	td->free_struct    = asn_DEF_NativeEnumerated.free_struct;
	td->print_struct   = asn_DEF_NativeEnumerated.print_struct;
	td->check_constraints = asn_DEF_NativeEnumerated.check_constraints;
	td->ber_decoder    = asn_DEF_NativeEnumerated.ber_decoder;
...
static void
mac_ContentionResolutionTimer_64_free(asn_TYPE_descriptor_t *td,
		void *struct_ptr, int contents_only) {
	mac_ContentionResolutionTimer_64_inherit_TYPE_descriptor(td);
	td->free_struct(td, struct_ptr, contents_only);
}

static int
mac_ContentionResolutionTimer_64_print(asn_TYPE_descriptor_t *td, const void *struct_ptr,
		int ilevel, asn_app_consume_bytes_f *cb, void *app_key) {
	mac_ContentionResolutionTimer_64_inherit_TYPE_descriptor(td);
	return td->print_struct(td, struct_ptr, ilevel, cb, app_key);
}
...
static asn_dec_rval_t
mac_ContentionResolutionTimer_64_decode_ber(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
		void **structure, const void *bufptr, size_t size, int tag_mode) {
	mac_ContentionResolutionTimer_64_inherit_TYPE_descriptor(td);
	return td->ber_decoder(opt_codec_ctx, td, structure, bufptr, size, tag_mode);
}
...
static asn_enc_rval_t
mac_ContentionResolutionTimer_64_encode_der(asn_TYPE_descriptor_t *td,
		void *structure, int tag_mode, ber_tlv_tag_t tag,
		asn_app_consume_bytes_f *cb, void *app_key) {
	mac_ContentionResolutionTimer_64_inherit_TYPE_descriptor(td);
	return td->der_encoder(td, structure, tag_mode, tag, cb, app_key);
...
static asn_dec_rval_t
mac_ContentionResolutionTimer_64_decode_xer(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
		void **structure, const char *opt_mname, const void *bufptr, size_t size) {
	mac_ContentionResolutionTimer_64_inherit_TYPE_descriptor(td);
	return td->xer_decoder(opt_codec_ctx, td, structure, opt_mname, bufptr, size);
}
...
static asn_enc_rval_t
mac_ContentionResolutionTimer_64_encode_xer(asn_TYPE_descriptor_t *td, void *structure,
		int ilevel, enum xer_encoder_flags_e flags,
		asn_app_consume_bytes_f *cb, void *app_key) {
	mac_ContentionResolutionTimer_64_inherit_TYPE_descriptor(td);
	return td->xer_encoder(td, structure, ilevel, flags, cb, app_key);
...
static asn_dec_rval_t
mac_ContentionResolutionTimer_64_decode_uper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints, void **structure, asn_per_data_t *per_data) {
	mac_ContentionResolutionTimer_64_inherit_TYPE_descriptor(td);
	return td->uper_decoder(opt_codec_ctx, td, constraints, structure, per_data);
}
...
static asn_enc_rval_t
mac_ContentionResolutionTimer_64_encode_uper(asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints,
		void *structure, asn_per_outp_t *per_out) {
	mac_ContentionResolutionTimer_64_inherit_TYPE_descriptor(td);
	return td->uper_encoder(td, constraints, structure, per_out);
...
static asn_per_constraints_t asn_PER_type_ra_ResponseWindowSize_constr_55 GCC_NOTUSED = {
	{ APC_CONSTRAINED,	 3,  3,  0,  7 }	/* (0..7) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_per_constraints_t asn_PER_type_mac_ContentionResolutionTimer_constr_64 GCC_NOTUSED = {
	{ APC_CONSTRAINED,	 3,  3,  0,  7 }	/* (0..7) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_per_constraints_t asn_PER_memb_maxHARQ_Msg3Tx_constr_73 GCC_NOTUSED = {
...
static asn_INTEGER_enum_map_t asn_MAP_ra_ResponseWindowSize_value2enum_55[] = {
	{ 0,	3,	"sf2" },
	{ 1,	3,	"sf3" },
	{ 2,	3,	"sf4" },
	{ 3,	3,	"sf5" },
...
static unsigned int asn_MAP_ra_ResponseWindowSize_enum2value_55[] = {
	7,	/* sf10(7) */
	0,	/* sf2(0) */
	1,	/* sf3(1) */
	2,	/* sf4(2) */
...
static asn_INTEGER_specifics_t asn_SPC_ra_ResponseWindowSize_specs_55 = {
...
static ber_tlv_tag_t asn_DEF_ra_ResponseWindowSize_tags_55[] = {
	(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (10 << 2))
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_ra_ResponseWindowSize_55 = {
	...
	"ra-ResponseWindowSize",
	ra_ResponseWindowSize_55_free,
	ra_ResponseWindowSize_55_print,
	ra_ResponseWindowSize_55_constraint,
	ra_ResponseWindowSize_55_decode_ber,
	ra_ResponseWindowSize_55_encode_der,
	ra_ResponseWindowSize_55_decode_xer,
	ra_ResponseWindowSize_55_encode_xer,
	ra_ResponseWindowSize_55_decode_uper,
	ra_ResponseWindowSize_55_encode_uper,
	0,	/* Use generic outmost tag fetcher */
...
static asn_INTEGER_enum_map_t asn_MAP_mac_ContentionResolutionTimer_value2enum_64[] = {
	{ 0,	3,	"sf8" },
	{ 1,	4,	"sf16" },
	{ 2,	4,	"sf24" },
	{ 3,	4,	"sf32" },
...
static unsigned int asn_MAP_mac_ContentionResolutionTimer_enum2value_64[] = {
	1,	/* sf16(1) */
	2,	/* sf24(2) */
	3,	/* sf32(3) */
	4,	/* sf40(4) */
...
static asn_INTEGER_specifics_t asn_SPC_mac_ContentionResolutionTimer_specs_64 = {
...
static ber_tlv_tag_t asn_DEF_mac_ContentionResolutionTimer_tags_64[] = {
	(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (10 << 2))
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_mac_ContentionResolutionTimer_64 = {
	...
	"mac-ContentionResolutionTimer",
	mac_ContentionResolutionTimer_64_free,
	mac_ContentionResolutionTimer_64_print,
	mac_ContentionResolutionTimer_64_constraint,
	mac_ContentionResolutionTimer_64_decode_ber,
	mac_ContentionResolutionTimer_64_encode_der,
	mac_ContentionResolutionTimer_64_decode_xer,
	mac_ContentionResolutionTimer_64_encode_xer,
	mac_ContentionResolutionTimer_64_decode_uper,
	mac_ContentionResolutionTimer_64_encode_uper,
	0,	/* Use generic outmost tag fetcher */
...
static ber_tlv_tag_t asn_DEF_ra_SupervisionInfo_tags_53[] = {
	(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
