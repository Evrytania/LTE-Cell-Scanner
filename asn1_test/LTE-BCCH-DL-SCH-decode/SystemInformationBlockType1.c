...
static int
memb_csg_Identity_constraint_2(asn_TYPE_descriptor_t *td, const void *sptr,
			asn_app_constraint_failed_f *ctfailcb, void *app_key) {
...
static asn_per_constraints_t asn_PER_memb_csg_Identity_constr_13 GCC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
...
static asn_TYPE_member_t asn_MBR_cellAccessRelatedInfo_2[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct SystemInformationBlockType1__cellAccessRelatedInfo, csg_Identity),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_BIT_STRING,
		memb_csg_Identity_constraint_2,
		&asn_PER_memb_csg_Identity_constr_13,
		0,
		"csg-Identity"
		},
};
...
static ber_tlv_tag_t asn_DEF_nonCriticalExtension_tags_30[] = {
