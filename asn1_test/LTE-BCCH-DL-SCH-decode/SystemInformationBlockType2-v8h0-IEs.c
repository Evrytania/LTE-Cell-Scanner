...
static int asn_MAP_SystemInformationBlockType2_v8h0_IEs_oms_1[] = { 0, 1 };
static ber_tlv_tag_t asn_DEF_SystemInformationBlockType2_v8h0_IEs_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_SystemInformationBlockType2_v8h0_IEs_tag2el_1[] = {
