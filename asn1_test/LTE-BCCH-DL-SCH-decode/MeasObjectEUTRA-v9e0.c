...
static asn_TYPE_member_t asn_MBR_MeasObjectEUTRA_v9e0_1[] = {
...
static ber_tlv_tag_t asn_DEF_MeasObjectEUTRA_v9e0_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_MeasObjectEUTRA_v9e0_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 } /* carrierFreq-v9e0 */
};
static asn_SEQUENCE_specifics_t asn_SPC_MeasObjectEUTRA_v9e0_specs_1 = {
