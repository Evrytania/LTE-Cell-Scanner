...
static asn_TYPE_member_t asn_MBR_STAG_ToAddMod_r11_1[] = {
...
static ber_tlv_tag_t asn_DEF_STAG_ToAddMod_r11_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_STAG_ToAddMod_r11_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* stag-Id-r11 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* timeAlignmentTimerSTAG-r11 */
};
static asn_SEQUENCE_specifics_t asn_SPC_STAG_ToAddMod_r11_specs_1 = {
