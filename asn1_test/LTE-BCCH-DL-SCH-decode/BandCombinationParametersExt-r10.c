...
static int asn_MAP_BandCombinationParametersExt_r10_oms_1[] = { 0 };
static ber_tlv_tag_t asn_DEF_BandCombinationParametersExt_r10_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_BandCombinationParametersExt_r10_tag2el_1[] = {
