...
static int
mbms_Priority_r11_3_constraint(asn_TYPE_descriptor_t *td, const void *sptr,
 ...
 */
static void
mbms_Priority_r11_3_inherit_TYPE_descriptor(asn_TYPE_descriptor_t *td) {
...
static void
mbms_Priority_r11_3_free(asn_TYPE_descriptor_t *td,
		void *struct_ptr, int contents_only) {
	mbms_Priority_r11_3_inherit_TYPE_descriptor(td);
	td->free_struct(td, struct_ptr, contents_only);
}

static int
mbms_Priority_r11_3_print(asn_TYPE_descriptor_t *td, const void *struct_ptr,
...
mbms_Priority_r11_3_decode_ber(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
mbms_Priority_r11_3_encode_der(asn_TYPE_descriptor_t *td,
...
static asn_dec_rval_t
mbms_Priority_r11_3_decode_xer(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
static asn_enc_rval_t
mbms_Priority_r11_3_encode_xer(asn_TYPE_descriptor_t *td, void *structure,
...
static asn_dec_rval_t
mbms_Priority_r11_3_decode_uper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
static asn_enc_rval_t
mbms_Priority_r11_3_encode_uper(asn_TYPE_descriptor_t *td,
...
static asn_per_constraints_t asn_PER_type_mbms_Priority_r11_constr_3 GCC_NOTUSED = {
	{ APC_CONSTRAINED,	 0,  0,  0,  0 }	/* (0..0) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_INTEGER_enum_map_t asn_MAP_mbms_Priority_r11_value2enum_3[] = {
	{ 0,	4,	"true" }
};
static unsigned int asn_MAP_mbms_Priority_r11_enum2value_3[] = {
	0	/* true(0) */
};
static asn_INTEGER_specifics_t asn_SPC_mbms_Priority_r11_specs_3 = {
...
static ber_tlv_tag_t asn_DEF_mbms_Priority_r11_tags_3[] = {
...
asn_TYPE_descriptor_t asn_DEF_mbms_Priority_r11_3 = {
	"mbms-Priority-r11",
	"mbms-Priority-r11",
	mbms_Priority_r11_3_free,
	mbms_Priority_r11_3_print,
	mbms_Priority_r11_3_constraint,
	mbms_Priority_r11_3_decode_ber,
	mbms_Priority_r11_3_encode_der,
	mbms_Priority_r11_3_decode_xer,
	mbms_Priority_r11_3_encode_xer,
	mbms_Priority_r11_3_decode_uper,
	mbms_Priority_r11_3_encode_uper,
	...
	&asn_PER_type_mbms_Priority_r11_constr_3,
...
static asn_SEQUENCE_specifics_t asn_SPC_nonCriticalExtension_specs_6 = {
	sizeof(struct MBMSInterestIndication_r11_IEs__nonCriticalExtension),
	offsetof(struct MBMSInterestIndication_r11_IEs__nonCriticalExtension, _asn_ctx),
	0,	/* No top level tags */
...
static asn_TYPE_member_t asn_MBR_MBMSInterestIndication_r11_IEs_1[] = {
...
static int asn_MAP_MBMSInterestIndication_r11_IEs_oms_1[] = { 0, 1, 2, 3 };
static ber_tlv_tag_t asn_DEF_MBMSInterestIndication_r11_IEs_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_MBMSInterestIndication_r11_IEs_tag2el_1[] = {
...
static asn_SEQUENCE_specifics_t asn_SPC_MBMSInterestIndication_r11_IEs_specs_1 = {
