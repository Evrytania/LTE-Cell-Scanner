...
asn1c  -S /usr/local/share/asn1c -fcompound-names -fskeletons-copy -gen-PER -pdu=auto 36331-c10.asn

% % % maybe no need ------------------------
converter-sample.c
add 
#define PDU BCCH_DL_SCH_Message //(or #define PDU BCCH_BCH_Message)
